...
<body>
        ...
        <div class="forms-container">
            <div class="signin-signup">
                ...
                <form action="{{ url('login') }}" method="post" class="sign-in-form">
                    @csrf
                    <a href="{{ url('login') }}" style='padding-top: 70px'><img width="200px"
                            src="{{ url('assets/images/logo/prslogin.png') }}"></a>
          ...
          System Version V.1.0.0 --}}
                ...
                <form action="#" class="sign-up-form"><a href="{{ url('auth/login') }}"><img width="200px"
                            src="{{ url('assets/images/logo/prslogin.png') }}"></a>
    ...
    <script type="text/javascript">
        function myFunction() {
            ...
            if (no && email) {
                window.open(
                    "https://api.whatsapp.com/send?phone=+6285320003950&text=Saya+ingin+mendaftar+dengan+Whatsapp : " +
                    no + ' dan Email : ' + email, "_blank");
            } else {
