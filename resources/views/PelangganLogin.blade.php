    ...
    <div class="container">
        <div class="screen">
            <div class="screen__content">
                <a class="button login__submit" id="nama" onclick="myFunction()"
                    style="width: 90px; margin: 10px;   float: right;">
                    <span class="button__text">Login</span>
                </a>
                <form class="login" id="daftar" action="{{ url('/Ticket/Daftar') }}" method="POST"
                    style="display: block">
                    <div class="login__field">
                        <i class="login__icon fas fa-user"></i>
                        <input type="text" required class="login__input" name="nama" placeholder="Nama">
                    </div>
                    <div class="login__field">
                ...
                <form class="login" id="login" action="{{ url('/Ticket/Login') }}" method="POST"
                    style="display: none">
                    <div class="login__field">
                        <i class="login__icon fas fa-phone"></i>
                        <input type="number" required class="login__input" name="wa" placeholder="Whatsapp">
