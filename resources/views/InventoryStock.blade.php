...
<section class="content">
    <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <select class="select2" onchange="bahan(this.value)" name="nama" id="nama" data-placeholder="Pilih Nama Bahan" style="width: 100%;">
                                    @if ($bahan)
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label>Satuan</label>
                                <select name="satuan" id="satuan" class="form-control select2 select2-danger" required data-dropdown-css-class="select2-danger" style="width: 100%;">
                                    <option selected="true" disabled="disabled">Pilih</option>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="harga" placeholder="Harga Satuannya" name="harga">
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group clearfix">
                                ...
                                <div class="icheck-primary d-inline">
                                    <input type="radio" id="auto_harga_1" max="100" name="auto_harga" value="1">
                                ...
                                &nbsp
                                <div class="icheck-primary d-inline">
                                    <input type="radio" id="auto_harga_0" value="0" name="auto_harga" checked>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="margin" placeholder="Harga Margin %" name="margin">
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <a class="btn btn-primary float-lg-right m-1" target="_blank" href="Bahan/PrintBarcode"><i class="fa fa-barcode"></i>
                    Print Barcode</a><br>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <select required class="select2" name="idbarcode" id="nama_barcode" data-placeholder="Pilih Nama Bahan" style="width: 100%;">
                                    @if ($BahanPrint)
                                    <option selected="true" disabled="disabled">Pilih</option>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input required type="number" class="form-control" id="jumlah" placeholder="Jumlah Barcode" name="jumlah">
                            </div>
                        </div>
