        ...
        <table id="manage" class="table table-bordered table-striped">
          ...
          <tbody>
            @foreach ($DataUsers as $v)
                  @if ($v['id'] != 1)
                    <tr>
                      <td><img width="30" class="rounded-circle" src="@if($v['img']) {{ $v['img'] }} @else http://prs/assets/images/unnamed.png @endif"></td>
                      <td>{{ $v['username'] }}</td>
                      <td>{{ $v['store'] }}</td>
                      <td>{{ $v['email'] }}</td>
                      ...
                      <td>
                          <div class="btn-group dropleft">
                              ...
                              <li><a class="dropdown-item" onclick="EditManage({{ $v['id'] }})" data-toggle="modal" data-target="#Modal" href="#"><i class="fas fa-pencil-alt" ></i> Edit</a></li>
                            </ul>
                          </div>
                    </tr>
                  @endif
