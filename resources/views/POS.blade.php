                        ...
                        <div class="card card-success card-outline" style="min-height: 600px">
                            <div class="card-header" style="display: flex">
                                <form id="FormBarcode" action="POS/Barcode" method="POST">
                                    <input autofocus type="search" class="form-control" name="id" id="barcode" placeholder="Barcode..">
                                </form>
                                <i class="fa fa-barcode" style="padding: 10px;padding: 10px;margin-right:5px;border-radius: 5px;margin-left: 5px;border: solid 1px #e1e1e1;"></i>


                                <input type="search" class="form-control" oninput="search(this.value)" id="search" placeholder="Search..">
                                <i class="fa fa-search" style="padding: 10px;padding: 10px;border-radius: 5px;margin-left: 5px;border: solid 1px #e1e1e1;"></i>
                            </div>
                            <div class="card-body" style="max-height: 500px;overflow-y:auto;" id="item">
                                <div class="waiting" style="position: absolute;height: 85%;width: 96%;background-color: #dfdfdf;z-index: 9999;border-radius: 10px;display:none;">
                                </div>
                                @if (count($item))
                                @foreach ($item as $v)
                                <div class="animate__animated animate__backInDown animate__faster item" id="pilihan_<?= $v['id'] ?>" onclick="pilih(<?= $v['id'] ?>, <?= $v['bahan_id'] ?> )">
                                    <div class="float-right"><b>
                                            @if ($v['qty'] < 5) <i class="fa fa-exclamation-triangle"></i>
                                                @endif
                                                {{ $v['qty'] . ' ' . $v['satuan'] }}
                                        </b>
                                    </div>
...
<!-- Modal -->
<div class="modal fade" id="transaksi" tabindex="-1" role="dialog" style="width:100%" aria-labelledby="transaksiLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            ...
            <div class="modal-body">
                ...
                <form id="bayarpos">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama" id="pengorder" aria-describedby="Pengorder" placeholder="Masukan Data">
                    </div>

                    <div class="form-group">
                        <label for="no">No Hp:</label>
                        <input type="number" class="form-control" name="no" id="no" aria-describedby="No" placeholder="Masukan Data">
                    </div>


                    <div class="form-group">
                        <label>Pemesan</label>
                        <select name="outlet_store" id="outlet_store" class="form-control select2" data-dropdown-css-class="select2-danger" style="width: 100%;">
                    ...
                    <div class="form-group">
                        <center>
                            <input type="number" class="form-control" style="width:40%" name="jumlah" id="jumlah" onkeyup="$('input[type=radio]').prop('checked', false)" aria-describedby="Jumlah" placeholder="Masukan Data">
                        </center>
                    </div>
...
<div class="modal fade" id="kembalian" tabindex="-1" role="dialog" style="width:100%" aria-labelledby="transaksiLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
