            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <input type="hidden" name="store" id="store" value="{{ request()->session()->get('store_id') }}">


                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label for="nama">Nama Bahan</label>
                                <select class="select2" name="nama" id="nama_tambah" data-placeholder="Pilih Nama Bahan" style="width: 100%;">
                                    @if ($bahan)
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label>Store</label>
                                <select name="store" id="store" onchange="inventory(this.value)" class="form-control select2 select2-danger" required data-dropdown-css-class="select2-danger" style="width: 100%;">
                                    <option selected="true" disabled="disabled">Pilih</option>
                                    @foreach ($store as $v)
                                    @if ($v['id'] != 1)
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <label for="qty">Qty Sekarang</label>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="ket" value="OPNAME" placeholder="Keterangan" name="ket">
                            </div>
                        </div>
