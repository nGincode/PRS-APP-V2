                ...
                @isset($JumlahOrder)
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info">
                            ...
                            <a href="{{ url('/order') }}" class="small-box-footer">More info <i
                ...
                @isset($JumlahIvn)
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            ...
                            <a href="{{ url('/ivn') }}" class="small-box-footer">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                @endisset
                ...
                @isset($JumlahPengadaan)
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-danger">
                            ...
                            <a href="{{ url('/pengadaan') }}" class="small-box-footer">More info <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                @endisset
