                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama" placeholder="Nama Olahan"
                                        name="nama">
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="konversi_penyajian" id="konversi_penyajian"
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $kode }}" disabled class="form-control"
                                        value="Pilih Kategori" id="kode" name="kode">
                                </div>
                            </div>
