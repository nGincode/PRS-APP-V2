...
function popup($icon, $toast, $pesan, reset = null) {
    ...
    if (reset) {
        ...
        if (
            $(".input-group-append").length &&
            !$("#show_hide_password").length
        ) {
...
jQuery.extend(jQuery.validator.messages, {
    ...
    maxlength: jQuery.validator.format(
        "Masukkan tidak lebih dari {0} karakter."
    ),
    minlength: jQuery.validator.format(
        "Silakan masukkan setidaknya {0} karakter."
    ),
    rangelength: jQuery.validator.format(
        "Silakan masukkan nilai antara panjang  {0} - {1} karakter."
    ),
...
$(document).ready(function () {
    ...
    $("#add_row_jam_kerja")
        ...
        .bind("click", function () {
            ...
            var html =
                '<div class="col-12 col-sm-12" id="isi_jam_kerja"><div class="form-group"><label for="nama_shift">Nama Shift</label> <input class="form-control" id="nama_shift" placeholder="Nama Shift" value="Shift ' +
                row_id +
